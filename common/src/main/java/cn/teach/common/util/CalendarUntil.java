...
public class CalendarUntil {
    ...
    public static Date ParseDate(Object obj, String format, Date defaultDate) {
        ...
        String dateStr = DataConvertor.ToString(obj);
     ...
     *
     * @param dt       时间
     * @param dateType 添加的时间类型 Calendar.DATE |Calendar.MONTH...
     * @param dates    正--添加 ，负--减少
     * @return
     */
    ...
    public static int DaysBetween(Date minDate, Date maxDate) {
        ...
        return DataConvertor.ToInteger(between_days);
    }
}
